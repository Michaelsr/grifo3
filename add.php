...
<div class="panel panel-default" id="dii">
  ...
  <form role="form" action="crud.php" method="post" id="frm">
    <div class="form-group">
      <label>Nombres</label>
      <input type="text" class="form-control" placeholder="Introduce tu Nombre" name="nombre" >
    </div>
    <div class="form-group">
      <label>Apellido Paterno</label>
      <input type="text" class="form-control" placeholder="Introduce tu Apellido Paterno" name="apellidop" >
    </div>
    <div class="form-group">
      <label>Apellido Materno</label>
      <input type="text" class="form-control" placeholder="Introduce tu Apellido Materno" name="apellidom" >
    </div>
